...
export const nav = {
  ...
  services: [
    { label: "Operação e Manutenção", href: "#servicos", key: "om" as ServiceKey },
    { label: "Usinas de Investimento", href: "#servicos", key: "usinas" as ServiceKey },
    { label: "Mobilidade Elétrica", href: "#servicos", key: "mobilidade" as ServiceKey },
    { label: "BESS", href: "#servicos", key: "bess" as ServiceKey },
    { label: "Energia com Desconto", href: "#servicos", key: "desconto" as ServiceKey },
    { label: "Eficiência Energética", href: "#servicos", key: "eficiencia" as ServiceKey },
    { label: "Gere sua Própria Energia", href: "#servicos", key: "gere" as ServiceKey },
  ],
