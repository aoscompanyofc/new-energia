...
export function EfficiencyIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M12 3a9 9 0 019 9M12 8v4l3 2" />
    </svg>
  );
}
...
export function MaintenanceIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M14.7 6.3a4 4 0 01-5.4 5.4L4 17v3h3l5.3-5.3a4 4 0 015.4-5.4l-2.5 2.5-2-2z" />
    </svg>
  );
}
...
export function LeafIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M5 21c8-1 14-7 15-16-9 1-15 7-16 15 0 0 0 1 1 1z" />
      <path d="M9 15c2-2 5-5 9-8" />
    </svg>
  );
}
...
export function WhatsappIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M20 12a8 8 0 10-14.3 4.9L4 21l4.3-1.6A8 8 0 0020 12z" />
